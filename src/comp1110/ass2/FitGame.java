...
//        check corner
        if (Board[0][0] == 0 && Board[0][1] == 1 && Board[1][0] == 1) {
            return false;
        }
        if (Board[4][0] == 0 && Board[3][0] == 1 && Board[4][1] == 1) {
            return false;
        }
        if (Board[0][9] == 0 && Board[1][9] == 1 && Board[0][8] == 1) {
            return false;
        }
        if (Board[4][9] == 0 && Board[3][9] == 1 && Board[4][8] == 1) {
            return false;
        }
...
//        check edge
        for (int i = 1; i < 4; i++) {
            if (Board[i][0] == 0 && Board[i - 1][0] == 1 && Board[i + 1][0] == 1 && Board[i][1] == 1) {
                return false;
            }
            if (Board[i][9] == 0 && Board[i - 1][9] == 1 && Board[i + 1][9] == 1 && Board[i][8] == 1) {
                return false;
            }
        }
        for (int j = 1; j < 9; j++) {
            if (Board[0][j] == 0 && Board[0][j + 1] == 1 && Board[0][j - 1] == 1 && Board[1][j] == 1) {
                return false;
            }
            if (Board[4][j] == 0 && Board[4][j + 1] == 1 && Board[4][j - 1] == 1 && Board[3][j] == 1) {
                return false;
            }
        }
        return true;
